...
// 				modelo_producto: result.data[i].modelo,
// 				imagen_producto: result.data[i].imagen_producto,
// 				precio_producto: result.data[i].precio_producto,
// 				descripcion_producto: result.data[i].descripcion
// 			})
// 			$('#new_item_link').show()
...
// 				mostrar_producto({
// 					$('#nombre_producto_1').html(arg.nombre_producto)
// 					$('#modelo_producto_1').html(arg.modelo_producto)
// 					$('#imagen_producto_1').attr('src',arg.imagen_producto)
// 					$('#descripcion_producto_1').html(arg.descripcion_producto)

// 					$('#nombre_producto_2').html(arg.nombre_producto)
// 					$('#modelo_producto_2').html(arg.modelo_producto)
// 					$('#imagen_producto_2').attr('src',arg.imagen_producto)
// 					$('#descripcion_producto_2').html(arg.descripcion_producto)
// 				})				
